...
There is a crisis of reproducibility in multiple branches of science. Among other problems, difficulties in getting the same results out of the same data and code of the original studies have been found – that's what is called “Computational reproducibility”. Given its social relevance, this study focused on the cases of computational reproducibility in neuroeconomics and behavioral finance. Of the 29 studies, 1 (3.4%) was fully computationally reproducible, while 15 (51.7%) were non-reproducible.
...
In addition to the problem that the foregoing poses for the advancement of science itself as a collective enterprise (Domínguez, 2017; Munafò et al., 2017), a kind of collateral damage can occur when knowledge that does not have the rigor expected of the scientific method has a direct impact on people's lives. Economics is an example of this and is not an exception to the rule: Chang & Li (2015) could only replicate the key results of 22 out of the 59 ($\approx 37.3\%$) articles they studied; after publishing *Capital in the Twenty-First Century*, Thomas Piketty (2014) received criticism for “*evidence of pervasive errors of historical fact, opaque methodological choices, and the cherry-picking of sources to construct favorable patterns from ambiguous data*” (Magness & Murphy, 2015, p. 1); the results presented in *Stocks for the Long Run* (Siegel, 2014; Siegel & Schwartz, 2022) regarding the superiority of investing in stocks over fixed income securities in the long term seem to be based on incomplete data (McQuarrie, 2021, 2023); Duke University closed an investigation in 2024 into the work of behavioral economist Dan Ariely, concluding that he used “data that had been fabricated” in some of his studies, without finding “evidence that Ariely knowingly used false data” (Taylor, 2024).

If the reproducibility crisis is a problem in any discipline, in this case it would be aggravated by the social relevance of its practical applications: the Government Pension Fund of Norway manages around \$2.1 trillion (Norges Bank Investment Management, n.d.); 15.3% of Spaniards have part of their savings in a pension plan (Funds Society, 2024); Germany announced a reform to invest part of the money that guarantees its citizens' future pensions in the stock market (Conde-Batalla, 2024); among others. If the managers of these huge amounts of money, on which the well-being and quality of life of future retirees will partially depend, extract their knowledge is from studies that do not meet the standards of the scientific method, we could be facing a serious problem.

Although research on economic inequality in society has little interest in asset management, the same is not true for the various disciplines that somehow integrate psychology and/or neuroscience with economics (such as neuroeconomics, behavioral economics, behavioral finance, or neuromarketing), whose emphasis on decision-making processes and the biases associated with them are directly related to investment practice: someone analyzing an asset that has been on a long upward streak must be careful that the recency bias does not lead them to think it is a good investment just because it has been rising lately (or the opposite, if the streak has been downward) regardless of what a cold and rigorous analysis of that asset says; if the person in charge of analyzing whether it is a good time or not to buy shares of Harley-Davidson or Ferrari is a motor enthusiast, he must be cautious that the confirmation bias does not make them see an opportunity that does not really exist due to their personal preferences. And so forth.
...
The objective of this research is to explore the computational reproducibility in the fields of neuroeconomics, behavioral sciences and related fields by trying to reproduce particular case studies.
...
The present study was documented in the format of a field journal (Sampieri et al., 2010). This form of record is suitable for documenting the steps taken in the attempt at reproduction. Problems found throughout the process were coded, as well as the way of trying to solve them through trial and error, which were noted with their results, positive or negative.
...
-Reproducible: A study that met the definition given at the beginning of this article: reaching consistent results (identical or with errors due exclusively to rounding) starting from the material provided by the original authors and their instructions, with no modifications other than adjusting the paths for reading the files if necessary or other minor technical issues.

-Reproducible with modifications: Consistent results have been reached, but with modifications that go beyond minor technical issues, such as the instructions given or the path adjustment or rewriting part of the algorithm that must process the data.

-Partially reproducible: Only part of the study is reproducible, either because the results in the other part diverge from the originals, or because they cannot be obtained for any reason.
...
-Non-reproducible: Different results from the originals are reached, or no results are obtained.

-Non-evaluable: Materials are shared, but their reproducibility could not be assessed for any reason, such as being shared in proprietary software not everyone has access to.
