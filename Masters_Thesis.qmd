...
| Error resolution support | ChatGPT-4o | ChatGPT-4o | ChatGPT-5 |
...
26 articles were selected to test their computational reproducibility.
...
| Error category                   | Number of errors (n = 29) |
|----------------------------------|---------------------------|
| Software incompatibility         | 4/29                      |
| Issues related to files analyzed | 5/29                      |
| Code-related problems            | 10/29                     |
| Data not shared                  | 10/29                     |

Results:

| Reproducibility outcome                   | Number of studies (n = 25) |
|-------------------------------------------|----------------------------|
| Non-reproducible                          | 15                         |
| Partially reproducible                    | 1                          |
| Partially reproducible with modifications | 7                          |
| Reproducible                              | 1                          |
...
The rest of the code runs without errors. I proceed to compare the results I get with the results published. I found some mismatches, such as results of 'Table 2' (according to the code) which are actually published under 'Table 1' in the paper or some differences due to rounding in Table B6. The only real mismatch is found in Table B2, where I am unable to make sense of my results compared to the published ones.
...
Two .dta files are shared - neither code nor instructions are shared.
