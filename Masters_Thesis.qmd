...
There is a crisis of reproducibility in multiple branches of science. Among other problems, difficulties in obtaining the same results out of the same data and code of the original studies have been found – that's what is called “Computational reproducibility”. Given its social relevance, this study focused on the cases of computational reproducibility in neuroeconomics and behavioral finance. Of the 29 studies analyzed, 1 (3.4%) was fully computationally reproducible, while 15 (51.7%) were non-reproducible.
...
The objective of this research is to explore computational reproducibility through a set of case studies drawn from neuroeconomics, behavioral finance, and related fields.

### Methods and Materials

**Procedure and Materials**

First, a series of articles was selected whose CR was tested following the authors' instructions, if any provided. These were the case studies referred to in the *Objectives* section. When shared, the code was run on the data, and the results encountered (code failures, problems with files to be read, and so on) were recorded in a field journal. Each of these steps is detailed in a subsequent section.
...
a\) Being an article whose subject matter falls within the previously mentioned areas, according to the author's expert criteria. Those including the keywords *behavioral finance, behavioral economics, decision making,* and *neuroeconomics* were sought.
...
Once the articles are selected, an attempt was made to reproduce them from scratch following the given instructions using a bottom-up process.
...
The recurring themes and patterns that emerged in a first reading of the journal were coded in a spreadsheet. A systematic qualitative analysis was then applied to them.
...
It is worth noting the willingness of many authors to share their material, thus contributing to the advancement of Open Science: Fareri et al. (2022) used openneuro.org and identifiers.org to store materials, and Payzan-LeNestour and Doran (2024) assigned a *Digital Object Identifier* or "DOI" (Wilkinson et al., 2016), complying with the FAIR principles of *Findable* and *Accessible*. However, the materials from Payzan-LeNestour and Woodford (2022) are uploaded to Dropbox and those from Payzan-LeNestour et al. (2026) to the Open Science Framework website. This is better than not sharing them, but it is not the optimal way to do so since they could disappear from the network at any moment.
...
Ioannidis, J. P. A. (2005). Why most published research findings are false. *PLoS Medicine, 2*(8), e124. <https://doi.org/10.1371%2Fjournal.pmed.0020124>
