...
I resume the search for articles to test its CR. I access the [Journal of Economic Behavior & Organization](https://www.sciencedirect.com/journal/journal-of-economic-behavior-and-organization) and type *behavioral finance* in the search box. Then, I limit the scope to the years 2020-2025 and *Open access & Open archive*. I look for articles including the queries in the keywords, title or a clear reference in the title, such as a reference to 'psychology and economics'. I proceed the same way with the terms *behavioral economics, neuroconomics,* and *decision making*. When the search gives over 50 articles, I look only for the 50 first.

I do the same in [Journal of Economic Psychology](https://www.sciencedirect.com/journal/journal-of-economic-psychology), and [Frontiers in Behavioral Economics](https://www.frontiersin.org/journals/behavioral-economics), with the type *Original Research* and date 01/01/2020-01/12/2025 for the latter. The process yields 46 articles to work with.
