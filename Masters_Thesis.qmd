...
There is a crisis of reproducibility in multiple branches of science. Among other problems, difficulties in getting the same results out of the same data and code of the original studies have been found – that's what is called “Computational reproducibility”. Given its social relevance, this study has focused on the cases of computational reproducibility in neuroeconomics and behavioral finance. Only 3.4% of the studies were fully computationally reproducible, with 51.7% being non-reproducible.
...
a\) Being an article whose subject matter falls within the previously mentioned areas, according to the author's expert criteria. Those including the keywords *behavioral finance, behavioral economics, decision making,* and *neuroeconomics* will be sought.
...
-Non-evaluable: Materials are shared, but its reproducibility couldn't be assessed for various reasons, for instance, being shared in proprietary software not everyone has access to.
...
Payzan-LeNestour, E. & Doran, J. (2024). Craving money? Evidence from the laboratory and the field. *Science Advances, 10*(2), eadi5034. [[http://doi.org/10.1126/sciadv.adi5034]{.underline}](http://doi.org/10.1126/sciadv.adi5034)
