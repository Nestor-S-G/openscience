...
Since the first reproduction attempt, the original study and its materials ar no longer available, but a updated version, *Stubborn by Design: When past rewards keep agents betting on known losses*.
...
With access to the propietary SPSS, an attempt for computational reproducibility is made for the Pilot study again. Results are the same for the F-value, \~ 133.93 found vs. 133.34 published. In this case, the mistmatches cannot be attributed to the used of proprietary instead of free software.
