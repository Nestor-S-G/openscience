...
With access to the proprietary SPSS, an attempt for computational reproducibility is made for the Pilot study again. Results are the same for the F-value, \~ 133.93 found vs. 133.34 published. In this case, the mismatches cannot be attributed to the used of proprietary instead of free software. Results found do not affect the conclusions of the original study.
