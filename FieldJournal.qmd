...
I access [the link](https://osf.io/zhnx2) provided in the paper. There I find a related project link where the data is shared. I download the .xlsx file. No computational environment, code or instructions are shared. So I try to deduce a way to analyze the data using R.

When I analyze the data using the script *CardOrDice.R*, I find results that are coherent with the published ones as well as some small differences probably due to rounding or using different software to analyze the data.
