...
#Simulate the choices of CbD agents with a mixed uncertainty effect----
...
for(ID in index_uncertainty){
  G=0
  C_kappa1=rtruncnorm(1, a=0.3, b=0.4, mean = 0.4, sd = 0.05)
...
for(ID in index_no_uncertainty){
  G=0
...
#save.image("Model recovery with a mixed uncertainty effect_low_trembling_40to60_same parameter as previous recovery.RData")