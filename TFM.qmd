...
Otra limitación es la falta de un archivo JupyterLab, Quarto o similares como los mencionados en las *Sugerencias a futuro* y que simplifiquen el proceso de reproducir computacionalmente el presente estudio.
...
Error in setwd("/Users/danielagrinblatt/Desktop/Elise/Data"): no es posible cambiar el directorio de trabajo
```
...
Por tanto, no se puede reproducir sólo con las dos condiciones señaladas en el archivo python_requirements.txt. Procedo a instalar xlrd y modificar la línea:
