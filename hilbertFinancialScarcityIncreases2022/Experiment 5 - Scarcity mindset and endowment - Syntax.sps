...
IF TD510 NE TD490 SwitchCount = SwitchCount + 1.
IF TD490 NE TD470 SwitchCount = SwitchCount + 1.
IF TD470 NE TD450 SwitchCount = SwitchCount + 1.
IF TD450 NE TD430 SwitchCount = SwitchCount + 1.
IF TD430 NE TD410 SwitchCount = SwitchCount + 1.
...
If TD510 EQ 1 AND SwitchCount NE 0 Exclude =1.
...
IF TD510 EQ 1 AND SwitchCount EQ 0 IndiffPoint = 520.
IF TD510 EQ 2 AND TD490 EQ 1 IndiffPoint = 500.
IF TD490 EQ 2 AND TD470 EQ 1 IndiffPoint = 480.
IF TD470 EQ 2 AND TD450 EQ 1 IndiffPoint = 460.
IF TD450 EQ 2 AND TD430 EQ 1 IndiffPoint = 440.
IF TD430 EQ 2 AND TD410 EQ 1 IndiffPoint = 420.
